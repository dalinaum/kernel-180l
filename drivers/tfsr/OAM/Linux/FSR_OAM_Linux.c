                 ...
                 UINT32  nLayer)
{
    ...
    do
    {
	   ...
	   || (nLayer == FSR_OAM_SM_TYPE_BML_VOL_1))
        {
#ifdef CONFIG_FSR_DUAL_VOLUME
            if (semaphore_use_bml[LAYER2SLOT(nLayer)]++ > 0)
            {
                *pHandle = semaphore_fsr_bml_handle[LAYER2SLOT(nLayer)];
                break;
            }
#else
	   ...
	   || (nLayer == FSR_OAM_SM_TYPE_BML_VOL_1))
        {
#ifdef CONFIG_FSR_DUAL_VOLUME
            semaphore_fsr_bml_handle[LAYER2SLOT(nLayer)] = sem_count;
#else
