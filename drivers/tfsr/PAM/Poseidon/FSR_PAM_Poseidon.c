...
#define     FSR_ENABLE_4K_ONENAND_LFT
    ...
    TNandGpioInterrupt* pNandGpioInterrupt;
        ...
        #define     FSR_ONENAND_PHY_BASE_ADDR_2ND       (0xB0040000)
#endif		
    #else
...
#ifdef CONFIG_FSR_DUAL_VOLUME
PRIVATE volatile OneNAND4kReg   *gpOneNANDReg_2nd               = (volatile OneNAND4kReg *) 0;
#endif
...
#ifdef CONFIG_FSR_DUAL_VOLUME
        nONDVirBaseAddr_2nd  = FSR_OAM_Pa2Va(FSR_ONENAND_PHY_BASE_ADDR_2ND);
#endif
#endif
...
#ifdef CONFIG_FSR_DUAL_VOLUME
        gpOneNANDReg_2nd  = (volatile OneNAND4kReg *) nONDVirBaseAddr_2nd;
#endif
#elif defined(FSR_ENABLE_FLEXOND_LFT)
...
#ifdef CONFIG_FSR_DUAL_VOLUME
        gstFsrVolParm[1].nBaseAddr[0] = nONDVirBaseAddr_2nd;
...
FSR_PAM_RegLFT(FSRLowFuncTbl  *pstLFT[FSR_MAX_VOLS])
{
    ...
    if (gstFsrVolParm[1].nDevsInVol > 0)
    {
        ...
        else if (gbFlexOneNAND[1] == FSR_OND_2K_PAGE)		
        {   
#if defined(FSR_ENABLE_ONENAND_LFT)
            pstLFT[nVolIdx]->LLD_Init               = FSR_OND_Init;
            pstLFT[nVolIdx]->LLD_Open               = FSR_OND_Open;
        ...
        else if (gbFlexOneNAND[1] == FSR_OND_4K_PAGE)	
        {
#if defined(FSR_ENABLE_4K_ONENAND_LFT)
            pstLFT[nVolIdx]->LLD_Init               = FSR_OND_4K_Init;
            pstLFT[nVolIdx]->LLD_Open               = FSR_OND_4K_Open;
